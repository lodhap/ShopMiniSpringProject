...
<table width="70%" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td class="td_default" align="center"><b>${order.userid }</b> 님의 주문이
			안전하게 처리되었습니다.</td>
	</tr>
		...
		<td>
			<table width="100%" border="1" style="border-collapse: collapse"
				...
				<tr>
					...
					<td class="td_default" height="35"> ${order.userid } 고객님</td>
				</tr>
				<tr>
					<td class="td_default" height="35"> 주소</td>
					<td class="td_default" height="35"> (${order.post })<br>
				...
				<tr>
					...
					<td class="td_default" height="35">${order.phone } </td>
				</tr>
			</table>
	</tr>
	</td>
			...
			<table width="100%" border="1" style="border-collapse: collapse"
				...
				<tr>
					<td height="35" class="td_default">
						<span class="a_default">${order.gName }</span>
					</td>
					<td height="35" class="td_default" align="center">
						<span  id = "price1">${order.gPrice }</span>원
					</td>
					<td height="35" class="td_default" align="center">
						<span id = "num1">${order.gAmount }</span>권
					</td>
					<td height="35" class="td_default" align="center">
		...
		<td>
			<table width="100%" border="1" style="border-collapse: collapse"
				...
				<tr>
					...
					<input type = 'text' id = 'total' value = '${order.gPrice*order.gAmount }' readonly>원
					</td>
				</tr>
				<tr>
